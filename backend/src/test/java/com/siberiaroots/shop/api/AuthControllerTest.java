...
class AuthControllerTest {
    ...
    class Login {
        ...
        @Test
        void returns400ForInvalidCredentials() throws Exception {
            String loginBody = objectMapper.writeValueAsString(new LoginRequest("unknown@example.com", "wrong"));
    ...
    class Verify {
        ...
        @Test
        void returns500ForInvalidToken() throws Exception {
        ...
        @Test
        void returns500ForNonExistentToken() throws Exception {
